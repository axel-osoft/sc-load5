...
*attrs* is the Python package that will bring back the **joy** of **writing claxxxsses** by relieving you from the drudgery of implementing object protocols (aka [dunder methods](https://www.attrs.org/en/latest/glossary.html#term-dunder-methods)).
